...
这是一套面向初学者和半懂不懂状态学习者的中文网络代理知识库。它用一个“桌面端 -> 入口 VPS -> 静态 ISP 出口”、“移动端 -> 入口 VPS 直出”和“个人设备 -> VPS -> 私域互联”的示例架构，把 IP、DNS、VPS、端口、TCP/IP、TLS、SOCKS5、Shadowsocks、VLESS Reality、Xray、mihomo、Clash Verge、Shadowrocket、TUN、WireGuard、链式代理、DNS/IPv6 泄漏和信任模型串起来讲清楚。
...
10. [私域网络：用 VPS 连接自己的设备](10-private-network.md)
11. [术语表](99-glossary.md)
...
- 想识别 API 中转、镜像站、反向代理 Token 骗局的用户
- 想用 VPS 搭建个人私域网络、远程访问自己设备的用户

## 不是什么

这不是机场推荐、节点分享、翻墙教程、账号中转教程、内网入侵教程或规避平台规则指南。它只解释网络与代理系统的基础概念、架构边界、常见骗局、个人设备互联和排错思路。
